  ...
  useEffect(() => {
    ...
    const workoutData: Workout[] = [
      ...
      },
      {
        ...
        calories: 120,
        description:
          "Uma aula com objetivo de melhorar o condicionamento físico geral. Ideal para quem está iniciando a prática de atividade física.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 178,
        description:
          "Essa aula é indicada para quem já tem uma boa experiência com treinos. Um treino que trabalha o corpo todo, com o objetivo de melhorar o condicionamento físico, força e resistência.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 32,
        description:
          "Uma aula focada no relaxamento e alongamento dos músculos do pescoço e trapézio. Lembre-se de manter a cabeça em posição neutra (queixo paralelo ao chão) durante sua jornada de trabalho, isso pode diminuir esse tipo de desconforto.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 48,
        description:
          "Dificuldades para dormir? Essa meditação pode te ajudar! Ela pode ser feita já na cama, com a luz baixa, e ao finalizar, evite novos estímulos e já siga para dormir, se possível.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 98,
        description:
          "Treino geral para todo o corpo, com um gasto calórico alto e trabalho muscular intenso.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 92,
        description:
          "Aula rápida, com o objetivo de trabalhar o corpo todo, buscando fortalecimento muscular e melhora do condicionamento físico.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 42,
        description:
          "A saudação a lua é uma prática refrescante e equilibrante, você se sentirá revigorado e com mais equilíbrio emocional. A sequência pode ser repetida quantas vezes você quiser.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 40,
        description:
          "Prática curta e completa para melhorar a sua flexibilidade. Pode ser feita todos os dias ao acordar, preparando o corpo para as atividades do dia ou antes de dormir.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 29,
        description:
          "Essa respiração pode ser feita por qualquer pessoa, a qualquer momento do dia. Irá trazer mais autocontrole que refletirá em diferentes aspectos no seu corpo e mente.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
      ...
      },
      {
        ...
        calories: 44,
        description:
          "Esse exercício de respiração é indicado para equilibrar seu mental e emocional. Ele equilibra os dois hemisférios cerebrais. Por trazer estímulo para os dois hemisférios (o que te acalma e o que te desperta) não é recomendado ser feito antes de dormir.",
        currentTime: 0,
        progress: [0],
        isCompleted: false,
